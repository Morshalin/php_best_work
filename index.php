...
<ol type="1">
	<li><a href="<?php echo BASE_URL; ?>/project/multi_delete/multipludelete.php">multiple Data Delete From Database</a> </li>
	<li><a href="filework.php" >File Upload and Download Using Database</a> </li>
